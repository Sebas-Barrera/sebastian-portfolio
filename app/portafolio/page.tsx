...
export default function Home() {
  ...
  const personSchemaJsonLd = {
    ...
    hasOccupation: {
      ...
      description:
        "Desarrollo de aplicaciones web y móviles, creación de APIs y arquitecturas backend escalables",
    },
    makesOffer: [
      {
        "@type": "Offer",
        itemOffered: {
          ...
          name: "Desarrollo Web",
          description:
            "Aplicaciones web modernas y responsivas con Next.js, React, Vue.js y Angular",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Apps nativas y multiplataforma para iOS y Android con Flutter, React Native y Swift",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          name: "Backend & APIs",
          description:
            "Arquitecturas robustas y escalables con Node.js, Laravel, Python y .NET",
        },
      },
    ],
  };
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            const animationType =
              entry.target.getAttribute("data-animation") || "fade-in-slide";
      ...
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-background/80 border-b border-border">
              ...
              <div className="flex items-center justify-between h-16">
                ...
                >
                  <div className="w-6 h-5 flex flex-col justify-between">
                    <span
                      className={`block h-0.5 w-full bg-text-primary transition-all duration-300 ${mobileMenuOpen ? "rotate-45 translate-y-2" : ""}`}
                    ></span>
                    <span
                      className={`block h-0.5 w-full bg-text-primary transition-all duration-300 ${mobileMenuOpen ? "opacity-0" : ""}`}
                    ></span>
                    <span
                      className={`block h-0.5 w-full bg-text-primary transition-all duration-300 ${mobileMenuOpen ? "-rotate-45 -translate-y-2" : ""}`}
                    ></span>
            ...
            {/* Mobile Menu */}
            <div
              className={`md:hidden overflow-hidden transition-all duration-300 ${mobileMenuOpen ? "max-h-96 border-b border-border" : "max-h-0"}`}
            >
              ...
              >
                ...
                Desarrollador de Software | Ingeniero en Software | Creador de Páginas Web
                  ...
                  <div className="flex flex-wrap gap-4 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.7s_forwards]">
                    <a
                      href="#contact"
                      className="px-8 py-4 bg-accent text-background rounded-full font-medium hover:bg-accent-light transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-accent/30"
                    >
                      Iniciar Proyecto
                    </a>
                    <a
                      href="#projects"
                      className="px-8 py-4 border border-border text-text-primary rounded-full font-medium hover:border-accent hover:text-accent transition-all duration-500 hover:scale-105"
                    >
                      Ver Trabajos
                    </a>
                  </div>
          ...
          >
            <div className="max-w-7xl mx-auto">
              <h2
                id="services-heading"
                className="text-3xl md:text-4xl font-semibold tracking-tight text-text-primary mb-12 text-center animate-fade-in-slide"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Desarrollo Web */}
                <article
                  className="group bg-surface border border-border rounded-2xl p-8 hover:border-accent organic-hover cursor-pointer animate-on-scroll animate-fade-in-slide animation-delay-100"
                  itemScope
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-all duration-500">
                    <svg
                      className="w-6 h-6 text-accent group-hover:scale-110 transition-transform duration-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                  ...
                  <h3
                    className="text-xl font-semibold text-text-primary mb-3 group-hover:text-accent transition-colors duration-300"
                    itemProp="name"
                  >
                ...
                {/* Desarrollo Móvil */}
                <article
                  className="group bg-surface border border-border rounded-2xl p-8 hover:border-accent organic-hover cursor-pointer animate-on-scroll animate-fade-in-slide animation-delay-300"
                  itemScope
                  itemType="https://schema.org/Service"
                >
                  <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-all duration-500">
                ...
                {/* Backend & APIs */}
                <article
                  className="group bg-surface border border-border rounded-2xl p-8 hover:border-accent organic-hover cursor-pointer animate-on-scroll animate-fade-in-slide animation-delay-500"
                  itemScope
                  itemType="https://schema.org/Service"
                >
                  <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-all duration-500">
          ...
          <section
            id="projects"
            className="relative z-10 py-20 px-6 lg:px-8 border-t border-border overflow-hidden"
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div
                ...
                style={{
                  animation: "float-slower 23s ease-in-out infinite",
                  animationDelay: "-15s",
                }}
              ></div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16 animate-on-scroll">
                ...
                <p className="text-text-secondary max-w-2xl mx-auto">
                  Soluciones reales que han transformado negocios. Algunos de
                    ...
                    <div className="space-y-20">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                          ...
                          <p className="text-text-secondary mb-6 leading-relaxed">
                            Aplicación móvil innovadora que ofrece retos con
                            diferentes temáticas para cualquier tipo de reunión,
                            desde pláticas profundas hasta diversión garantizada
                            en fiestas. Desarrollada en colaboración con
                            <span className="text-accent font-medium">
                              {" "}
                              Techvision
                            </span>{" "}
                            como socios, esta app promete transformar la forma
                            en que las personas interactúan y se divierten en
                            grupos.
                          </p>
                          ...
                          <div className="mb-6 p-4 bg-accent/5 border border-accent/20 rounded-xl">
                            <p className="text-sm text-text-secondary">
                              ...
                              App Store y Play Store (próximamente)
                            </p>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                          ...
                          <p className="text-text-secondary mb-6 leading-relaxed">
                            Plataforma móvil premium dedicada al mundo esotérico
                            y holístico. Ofrece contenido especializado sobre
                            fases lunares y su significado, simbolismo de velas,
                            guías para rituales espirituales, y un juego de
                            Tarot Sí/No para consultas personales. Incluye un
                            feed social donde expertos comparten publicaciones y
                            conocimientos. Desarrollada en colaboración con{" "}
                            <span className="text-accent font-medium">
                              Techvision
                            </span>{" "}
                            como socios. Acceso mediante suscripción mensual o
                            anual con pasarela de pagos integrada.
                          </p>
                          <div className="flex flex-wrap gap-2 mb-6">
                            <span className="px-3 py-1 bg-surface border border-border text-text-primary text-xs rounded-full">
                              Expo
                          ...
                          <div className="mb-6 p-4 bg-accent/5 border border-accent/20 rounded-xl">
                            ...
                            <p className="text-sm text-text-secondary mt-1">
                              ...
                              Suscripción mensual/anual con pasarela de pagos
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                                Contenido:
                              </span>{" "}
                              Tarot, fases lunares, velas, rituales y comunidad
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                                Mi Rol:
                    ...
                    <div className="space-y-20">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                          ...
                          <p className="text-text-secondary mb-6 leading-relaxed">
                            Plataforma SaaS integral diseñada para la
                            digitalización y gestión operativa de clínicas
                            ópticas. Unifica el expediente clínico oftalmológico
                            con el punto de venta, inventarios y agenda en una
                            sola interfaz. Su arquitectura multi-tenant permite
                            administrar múltiples organizaciones y sucursales de
                            manera centralizada, ofreciendo a los dueños de
                            ópticas control total sobre su negocio y a los
                            optometristas herramientas especializadas para la
                            consulta.
                          </p>
                          <div className="flex flex-wrap gap-2 mb-6">
                            <span className="px-3 py-1 bg-surface border border-border text-text-primary text-xs rounded-full">
                          ...
                          <div className="mb-6 p-4 bg-accent/5 border border-accent/20 rounded-xl">
                            <p className="text-sm text-text-secondary">
                              ...
                              Arquitectura Multi-tenant, Expediente Clínico,
                              POS, Inventarios
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                            ...
                            <p className="text-sm text-text-secondary mt-1">
                              ...
                              Lead Full-stack Developer (Arquitectura &
                              Frontend)
                            </p>
                            <div className="mt-8 pt-6 border-t border-white/5">
                              <p className="text-sm font-medium text-text-secondary mb-4">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                          ...
                          <p className="text-text-secondary mb-6 leading-relaxed">
                            Plataforma web especializada en pronósticos
                            deportivos y parlays de múltiples deportes. Sistema
                            de membresías que permite acceso a contenido
                            gratuito y premium. Integración con autenticación de
                            Google para facilitar el registro. Los usuarios
                            pueden consultar tips y parlays de expertos en
                            diferentes disciplinas deportivas. Desarrollada en
                            colaboración con
                            <span className="text-accent font-medium">
                              {" "}
                              Techvision
                            </span>{" "}
                            como socios. La plataforma funciona como un centro
                            de información, sin realizar apuestas directamente.
                          </p>
                          <div className="flex flex-wrap gap-2 mb-6">
                            <span className="px-3 py-1 bg-surface border border-border text-text-primary text-xs rounded-full">
                              Angular
                          ...
                          <div className="mb-6 p-4 bg-accent/5 border border-accent/20 rounded-xl">
                            <p className="text-sm text-text-secondary">
                              ...
                              Tips gratuitos y premium, múltiples deportes
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                                Autenticación:
                              </span>{" "}
                              Google OAuth para acceso rápido
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                                Modelo:
                              </span>{" "}
                              Freemium con membresías premium
                            </p>
                            <p className="text-sm text-text-secondary mt-1">
                              <span className="text-accent font-medium">
                                Mi Rol:
                              </span>{" "}
                              Full-stack Developer (principalmente Frontend)
                            </p>
                            <div className="mt-8 pt-6 border-t border-white/5">
                              <p className="text-sm font-medium text-text-secondary mb-4">
                                Disponible en:
          ...
          <section
            id="about"
            className="relative z-10 py-20 px-6 lg:px-8 bg-background border-t border-border"
          >
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div
                ...
                {/* Logo o imagen */}
                <div
                  className="relative flex items-center justify-center animate-on-scroll"
                  data-animation="fade-in-right"
                >
                  {/* Efecto glow detrás */}
          ...
          <section
            id="ideas"
            className="relative z-10 py-20 px-6 lg:px-8 border-t border-border bg-surface/30"
          >
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-sm text-blue-400">
                  ...
                  Para proyectos de gran escala, cuento con el respaldo del
                  equipo Techvision
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-secondary">
                          Evaluamos el potencial y rentabilidad
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-secondary">
                          Cada quien obtiene un porcentaje del proyecto
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-background border border-border rounded-2xl p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-text-secondary text-sm">
                        Emprendedores con conocimiento del sector
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-accent/5 border border-accent/20 rounded-xl">
                    <p className="text-sm text-text-secondary">
                      <span className="text-accent font-medium">Nota:</span>{" "}
                      Firmamos acuerdos de confidencialidad (NDA) para proteger
                      tu idea desde el primer contacto.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 pt-12 border-t border-border">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-6">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 text-text-primary hover:text-accent transition-colors"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
  ...
  const sendEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://formsubmit.co/ajax/nexdevcoding@gmail.com",
        {
          method: "POST",
          headers: {
      ...
      {submitStatus === "limit" && (
        <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
          <p className="text-yellow-400 text-sm">
            Has alcanzado el límite de envíos (2 mensajes). Por favor espera{" "}
            {remainingTime} minutos para enviar otro mensaje, o contáctanos
            directamente a nexdevcoding@gmail.com
          </p>
        </div>
      )}
      ...
      <div className="relative bg-surface/50 backdrop-blur-sm border-2 border-border rounded-3xl p-6 group-hover:border-accent/50 transition-all duration-500">
        ...
        {showSwipeHint && currentIndex === 0 && (
          <div className="absolute top-1/2 right-4 -translate-y-1/2 z-30 md:hidden pointer-events-none">
            <div
              className="flex items-center gap-2 bg-accent/90 text-background px-3 py-2 rounded-full text-xs font-medium shadow-lg"
